...
public class PasisiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pasisi);
    ...
    private void setupRoomCard(int cardViewId, int mapDirectionId, int callDelvicId, int bookButtonId, String roomName, String phoneNumber, String bookedKey, String calledKey) {
        ...
        mapDirection.setOnClickListener(v -> {
            Intent mapIntent = new Intent(PasisiActivity.this, MapActivity.class);
    ...
    private void updateButtonState(Button button, boolean isBooked, boolean isCalled) {
        if (isBooked) {
            ...
            button.setEnabled(false); // Disable the button when booked.
        } else {
            button.setEnabled(true); //Enable button when not booked.
            if (isCalled) {
